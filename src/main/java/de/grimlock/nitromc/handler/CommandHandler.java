...
public class CommandHandler {
    ...
    private static class DynamicCommand extends BukkitCommand {
        ...
        protected DynamicCommand(@NotNull String name, @NotNull String description, @NotNull String usageMessage, @NotNull java.util.List<String> aliases, org.bukkit.command.CommandExecutor executor) {
